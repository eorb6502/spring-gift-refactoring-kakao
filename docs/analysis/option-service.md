...
- 관련 파일:
  - `src/main/java/gift/option/OptionController.java` (REST API)
  - `src/main/java/gift/option/Option.java` (엔티티)
  - `src/main/java/gift/option/OptionRepository.java`
  - `src/main/java/gift/option/OptionRequest.java`
  - `src/main/java/gift/option/OptionResponse.java`
  - `src/main/java/gift/order/OrderController.java` (옵션 재고 차감 호출)
...
1. `OptionService` 클래스 생성 (`src/main/java/gift/option/OptionService.java`)
   - `@Service` 어노테이션
